...
function getVariantSegmentFromTitle(title, segmentDelimiterPatterns, searchDirection) {
...
function getCoverLetterDescriptionFromTitle(title) {
    return title.match(patterns.coverLetter) !== null
        ? getVariantSegmentFromTitle(title, [patterns.cover, patterns.letter], "forwards")
        : ""
}
...
function parseVariantDescriptionFromTitle(comic) {
    ...
    comic.unparsedCoverLetterDescription = getCoverLetterDescriptionFromTitle(comic.title)
    comic.title = removeSegmentFromTitle(comic.title, comic.unparsedCoverLetterDescription)
    comic.unparsedAdditionalDescriptions = getAdditionalDescriptionsFromTitle(comic.title)
